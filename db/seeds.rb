...
#cascades
review1 = Review.create(rating: 4, review_text: "This hike was just ok! I got tired halfway through and forgot water", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike4.id)
review2 = Review.create(rating: 5, review_text: "Great Hike! Had so much fun.", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike4.id)
review3 = Review.create(rating: 5, review_text: "My dog loves this hike and so do I! Incredible views", activity_date: "2021-02-23", user_id: user3.id, hike_id: hike4.id)
review4 = Review.create(rating: 2, review_text: "Bad Hike.  I hate exercise.", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike4.id)
review5 = Review.create(rating: 4, review_text: "Don't forget sunscreen!", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike3.id)
review6 = Review.create(rating: 5, review_text: "The views were ok.  My backyard is better", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike3.id)
review7 = Review.create(rating: 5, review_text: "I got lost for 6 hours, but otherwise had a great time", activity_date: "2021-02-23", user_id: user3.id, hike_id: hike3.id)
review8 = Review.create(rating: 2, review_text: "Wow so much fun! I want to do this every weekend", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike3.id)
review9 = Review.create(rating: 4, review_text: "A marmot stole my lunch! Bummer, but fun otherwise", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike2.id)
review10 = Review.create(rating: 5, review_text: "We crushed miles today. Good times!", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike2.id)
review11 = Review.create(rating: 5, review_text: "Don't forget a snack!", activity_date: "2021-02-23", user_id: user3.id, hike_id: hike2.id)
review12 = Review.create(rating: 2, review_text: "This hike was uphill both ways.  Don't recommend.", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike2.id)
review13 = Review.create(rating: 4, review_text: "It's true, the lake is blue!", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike1.id)
review14 = Review.create(rating: 5, review_text: "I could not find the lake.  I also can't find my car.  It's getting dark. Send help!", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike1.id)
...
review16 = Review.create(rating: 2, review_text: "Too many trees, wouldn't recommend", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike1.id)


#acadia
# review17 = Review.create(rating: 4, review_text: "Almost fell off a cliff! Worth it!", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike5.id)
# review18 = Review.create(rating: 5, review_text: "Don't go if you're scared of heights!", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike5.id)
# review19 = Review.create(rating: 5, review_text: "I had so much fun!", activity_date: "2021-02-23", user_id: user3.id, hike_id: hike5.id)
# review20 = Review.create(rating: 2, review_text: "Not sure why this is rated hard, I did it backwards, in heels, with my eyes closed.", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike5.id)
# review21 = Review.create(rating: 4, review_text: "Great sunrise views!", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike6.id)
# review22 = Review.create(rating: 5, review_text: "Make sure you pack a picnic, there are no restaurants at the summit", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike6.id)
# review23 = Review.create(rating: 5, review_text: "Too steep!!! I got scared", activity_date: "2021-02-23", user_id: user3.id, hike_id: hike6.id)
# review24 = Review.create(rating: 2, review_text: "Don't do this hike in January, too much snow", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike6.id)
# review25 = Review.create(rating: 4, review_text: "A nice gentle stroll!", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike7.id)
# review26 = Review.create(rating: 5, review_text: "Too many tourists on this one. Crowded.", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike7.id)
...
# review28 = Review.create(rating: 2, review_text: "I saw a fish!", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike7.id)
# review29 = Review.create(rating: 4, review_text: "Don't swim here, trust me.  You will die.", activity_date: "2021-02-23", user_id: user1.id, hike_id: hike8.id)
# review30 = Review.create(rating: 5, review_text: "I saw thunder hole, now how do I get to lightning hole?", activity_date: "2021-02-23", user_id: user2.id, hike_id: hike8.id)
# review31 = Review.create(rating: 5, review_text: "Big waves! Cool.", activity_date: "2021-02-23", user_id: user3.id, hike_id: hike8.id)
# review32 = Review.create(rating: 2, review_text: "Bring your rain jacket, you will get wet!", activity_date: "2021-02-23", user_id: user4.id, hike_id: hike8.id)
